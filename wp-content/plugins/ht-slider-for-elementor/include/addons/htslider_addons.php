...
class Htsliderpro_Elementor_Widget_Sliders extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label'             => esc_html__( 'Style', 'ht-slider' ),
                        ...
                        <div class="htb-container">
                            <div class="content">
                                <div class="post-inner">
                                    <?php 
                                        if( $item['subtitle']  ){
                                            printf('<%s class="htslider-subtitle">%s</%s>', $html_subtitle_tag, wp_kses_post( $item['subtitle'] ), $html_subtitle_tag );
                                        }
                                        if(  $item['title']  ){
                                            printf('<%s class="htslider-title">%s</%s>', $html_title_tag, wp_kses_post( $item['title'] ), $html_title_tag );
                                        }
                                        if(  $item['desc'] ){
