...
class HTSlider_Elementor_Widget_Post_Slider extends Widget_Base {
            ...
            <div class="content">
                <div class="post-inner">
                    ...
                    <?php if( $settings['show_title'] == 'yes' ): 
                        ...
                        printf('<%s class="htslider-title"><a href="%s">%s</a></%s>',$html_title_tag,get_the_permalink(),wp_trim_words( get_the_title(), $settings['title_length'], '' ),$html_title_tag); 
                    ...
                    ?>
                        <div class="post-btn">
                            <a class="readmore-btn" href="<?php the_permalink();?>"><?php echo esc_html__( $settings['read_more_txt'], 'ht-slider' );?></a>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
    ...
    public function htslider_render_loop_thumbnail( $thumbnails_size = 'full' ) {
        if ( has_post_thumbnail() ){
            ...
            echo '<img src="'.HTSLIDER_PL_URL.'/assets/images/image-placeholder.png" alt="'.get_the_title().'" />';
        }
    ...
    public function show_post_source(){
        ...
        $this->add_control(
            ...
            [
                ...
                'raw' => sprintf(
                    __('Upgrade to pro version to use this feature %s Pro Version %s', 'ht-slider'),
